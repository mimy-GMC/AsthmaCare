<section class="health-form space-y-6">
    <header>
        <h2 class="text-lg font-heading font-bold text-red-600">
    ...
    <x-danger-button
        type="button" 
        class="btn-health btn-health-danger" 
        x-data=""
        ...
        <form method="post" action="{{ route('profile.destroy') }}" class="p-6 space-y-4">
            ...
            <div>
                ...
                <x-text-input
                    ...
                    name="password"
                    type="password"
                    class="health-form-input mt-1 block w-3/4"
            ...
            <div class="flex justify-end gap-3">
                ...
                <x-danger-button type="submit" class="btn-health btn-health-danger">
                    {{ __('Supprimer le compte') }}
                </x-danger-button>
            </div>
        </form>
